...
public static void main(String[] args)
{
	...
	String response3 = webTarget.path("rest").path("friends").path("update")
			.request().accept(MediaType.APPLICATION_JSON).post(Entity.entity(f,MediaType.APPLICATION_JSON)).toString();
	System.out.println(response3);
	
	String message3 = webTarget.path("rest").path("friends").path("update").request().accept(MediaType.APPLICATION_JSON).post(Entity.entity(f,MediaType.APPLICATION_JSON)).toString();
