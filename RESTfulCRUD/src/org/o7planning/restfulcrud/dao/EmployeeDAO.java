...
public class EmployeeDAO {
    ...
    private static void initEmps() {
        Employee emp1 = new Employee("E01", "Smith", "Clerk",10000,2);
        Employee emp2 = new Employee("E02", "Allen", "Salesman",15000,3);
        Employee emp3 = new Employee("E03", "Jones", "Manager",20000,4);
